...
if ([string]::IsNullOrWhiteSpace($config.PrinterStreamUrl) -and (Get-Item $config.CameraUrlFile).Length -eq 0) {
...
$studioFfmpeg = $null
if (-not [string]::IsNullOrWhiteSpace($config.PrinterStreamUrl)) {
